...
const IntroductionSectionMobile = () => (
  <section className={styles.content}>
    ...
    <p className={styles.about}>
      Looking for job positions of Frontend Developer. Interested in contributing to your projects.
      One semester away from graduating as computer security specialist. Like to play CTFs.
    </p>
